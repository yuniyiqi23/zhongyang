...
public class ZTestReport implements IReporter {
	...
	private String path = System.getProperty("user.dir") + File.separator +
			"src\\main\\resources\\ZTestReport\\report.html";

	private String templatePath = System.getProperty("user.dir") + File
			.separator + "src\\main\\resources\\ZTestReport\\template";
